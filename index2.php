...
<body>
    ...
    <div id="templatemo_wrapper">
        ...
        <div id="templatemo_header">
            <img width="950" src="assets_front/images/templatemo_service.png" alt="Slider" />
            <div class="clear"></div>
        </div> <!-- END of header -->
        <div id="templatemo_main"><span class="mf mft"></span><span class="mf mfb"></span>
            ...
            include "koneksi.php";
            $idkategori = $_GET['id'];
            $query = mysqli_query($koneksi, "SELECT data_barang.*, kategori.nama_kategori FROM data_barang
