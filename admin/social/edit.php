...
$query = mysqli_query($koneksi, "SELECT * FROM social WHERE id= '$id'");
                    ...
                    <form action="proses_edit.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_sosmed" class="form-control" placeholder="Masukan Nama Barang" value="<?= $nama_sosmed ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Link</label>
                                <textarea name="link" class="form-control" rows="3" required><?= $link ?></textarea>
                            </div>
                            <div class="form-group">
