        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Media Sosial</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active">Data Media Sosial</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tabel Data Media Sosial</h3>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img width="100" src="gambar/<?= $data['icon']; ?>" width="100px">
                                        </td>
                                        <td class="text-center">
                                            <a href="edit.php?id=<?= $data['id']; ?>" class="btn btn-warning btn-lg">Edit</a>
                                            <a href="proses_hapus.php?id=<?= $data['id']; ?>" class="btn btn-danger btn-lg">Hapus</a>
                                        </td>
                                    </tr>
                                <?php }
                                ?>
